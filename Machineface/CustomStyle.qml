...
ButtonStyle {
        ...
        background: Rectangle {
            ...
            gradient: Gradient {
                GradientStop { position: 0 ; color: control.pressed ? Qt.darker(baseColor, 1.05+darkness) : Qt.darker(baseColor, 0.85+darkness) }
                GradientStop { position: 1 ; color: control.pressed ? Qt.darker(baseColor, 1.2+darkness) : Qt.darker(baseColor, 1+darkness) }
            }
        }
        label: Item {
